...
> ⚠️ **SUBMITTED TO TAK.GOV FOR APPROVAL — NOT YET AVAILABLE FOR DOWNLOAD.** This plugin has been submitted to the TAK Product Center for review and is pending approval. It cannot be installed at this time.
...
This plugin has been submitted to TAK.Gov (TAK Product Center) for approval. It is **not yet available for download**. Once approved, installation instructions will be added here.
